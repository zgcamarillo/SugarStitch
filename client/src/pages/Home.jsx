// Introduction + Sustainabilitty Stats
        ...
        <div id="home-page">
            ...
            <div className="info-cards">
                ...
                <div className="cards" id="card-three">
                    ...
                    <p>Step by Step patterns designed for beginner and growing crocheters.</p>
                </div>
                <div className="cards" id="card-one">
                    <div className="tape"></div>
                    <img src="/images/eco-starter.png" alt="Leaf in a pot" />
                    <h2>Crochet Sustainability</h2>
                    <p>Make thoughtful choices with eco-friendly yarn suggestions and tips.</p>
                </div>
                <div className="cards" id="card-two">
                    <div className="tape"></div>
                    <img src="/images/first-stitch.png" alt="Crown" />
                    <h2>Stay Motivated</h2>
                    <p>Track your progress, complete patterns, and earn achievements as you go. Turn every stitch into a rewarding journey.</p>
                </div>
